...
router.use("/access-controls", authenticateToken, csrfProtection, checkApiAccess, accessControlRoutes);
router.use("/auth", authRoutes);
router.use("/account", authenticateToken, csrfProtection, checkApiAccess, accountRoutes);
router.use("/leave", authenticateToken, csrfProtection, checkApiAccess, leaveRoutes);
router.use("/classes", authenticateToken, csrfProtection, checkApiAccess, classesRoutes);
router.use("/class-teachers", authenticateToken, csrfProtection, checkApiAccess, classTeacherRoutes);
router.use("/sections", authenticateToken, csrfProtection, checkApiAccess, sectionRoutes);
router.use("/students", authenticateToken, csrfProtection, checkApiAccess, studentsRoutes);
router.use("/notices", authenticateToken, csrfProtection, checkApiAccess, noticesRoutes);
router.use("/staffs", authenticateToken, csrfProtection, checkApiAccess, staffsRoutes);
router.use("/departments", authenticateToken, csrfProtection, checkApiAccess, departmentRoutes);
router.use("/roles", authenticateToken, csrfProtection, checkApiAccess, rpRoutes);
